...
<html>
  ...
  <body>
    ...
    <div class="block">
      <div class="row-fluid">
        <div class="span12">
          <header class="group" style="background:none;background-color:#333;color:#eee;"><h1 class="pull-left"><i class="icon-envelope"></i> Add Cancellation Question</h1></header>
        </div>
      </div>
      <div class="row-fluid">
        <div class="span12">
          <g:form name="cancellationQuestion" action="add">
            ...
            <div class="form-actions">
              <div class="pull-left">
                <g:submitButton name="submit" value="Add Question" class="btn btn-primary"></g:submitButton>
